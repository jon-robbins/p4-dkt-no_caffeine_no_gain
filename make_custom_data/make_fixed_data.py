...
def feature_engineering(df):
     ...
     # Figure out if the question is empty in the middle (1,2,3,,5)
     ...
     # Calculate the user's total correct answer/number of answers/correct answer rate for the test paper the user solved (3 times if solved 3 times)
...
def caffeine_feature(df):
     ...
     assess_df['assessment_correct_answer'] = assess_df.groupby('assesmentItemID')['answerCode'].transform(lambda x: x.cumsum().shift(1))
